...
AIRPORT_OVERRIDES = {
    ...
    "KWJ": ("광주공항", "Gwangju Airport", "KR", 7),
    "MWX": ("무안국제공항", "Muan International Airport", "KR", 8),
    "YNY": ("양양국제공항", "Yangyang International Airport", "KR", 9),
    ...
    "PVG": ("상하이푸둥국제공항", "Shanghai Pudong International Airport", "CN", 1),
    "PEK": ("베이징 서우두 국제공항", "Beijing Capital International Airport", "CN", 2),
    "CAN": ("광저우 바이윈 국제공항", "Guangzhou Baiyun International Airport", "CN", 3),
    "SZX": ("선전 바오안 국제공항", "Shenzhen Baoan International Airport", "CN", 4),
    "TAO": ("칭다오 자오둥 국제공항", "Qingdao Jiaodong International Airport", "CN", 5),
