...
SCREEN_LINKS = [
    {"key": "documents", "label": "📄 서류 작성", "url": "/documents/new",
     ...
     "words": ("서류", "인보이스", "invoice", "송장", "패킹", "packing", "명세서", "b/l", "bl",
               "선하증권", "작성", "발행")},
    # 아이콘과 이름은 사이드바·상담 탭과 **같아야** 합니다(routes/sidebar.py).
    # 같은 화면으로 가는 길이 자리마다 다른 모양이면 같은 곳인지 알 수 없습니다.
    # 배(🚢)는 나르는 일, 상자(📦)는 컨테이너입니다. (2026-09-26)
    {"key": "planning", "label": "🚢 운송 예상 견적", "url": "/planning/new",
