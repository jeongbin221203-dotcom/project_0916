...
RULES = [
    ...
    _rule(
        "tobacco", "담배 · 담배사업법",
        chapters=["24"],
        documents=["담배제조업 허가증 (제조자)", "담배 수출 신고 서류",
                   "수입국 담배 표시·포장 규정 확인서",
                   "담배소비세·지방교육세 면세 신청서 (수출분)"],
        agency="기획재정부 · 관할 세무서 · 한국담배협회",
        law="담배사업법 · 지방세법 · 국민건강증진법",
        why="담배는 아무나 만들거나 팔 수 없습니다. 제조·수입판매업 허가가 있어야 하고, "
            "수출분은 담배소비세를 면제받는 절차가 따로 있습니다. "
            "수입국마다 경고 문구·그림·포장 규격을 법으로 정해 두어, "
            "우리 포장 그대로 보내면 통관에서 막힙니다.",
        link="통합공고",
    ),
    _rule(
